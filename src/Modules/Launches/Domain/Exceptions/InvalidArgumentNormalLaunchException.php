...
final class InvalidArgumentNormalLaunchException extends InvalidArgumentLaunchException
{
    public function __construct(
        ...
        parent::__construct(
            sprintf(
                "Normal launch not valid, number of frames <%d> or total pins knocked down <%d> is not valid",
                $this->numFrame->value(),
